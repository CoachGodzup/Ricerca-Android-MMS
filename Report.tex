...
between devices with this kernel\cite{GoogleDashboard}:
...
Figure \ref{Android structure (in red, linux kernel parts, in green C++ libraries, in blue Dalvik-interpreted Java applications)}
shows Android System Architecture schema \cite{WIKI}.
...
causing problems of usability and security. The majority of application
is written using PMEM approach.
