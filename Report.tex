...
\section{Low level management and integration with HW resources}
...
\begin{tabular}[t]{|>{\centering}p{0.2\columnwidth}|>{\raggedright}p{0.4\columnwidth}|>{\raggedright}p{0.4\columnwidth}|}
\hline 
...
\begin{tabular}[t]{|>{\centering}p{0.18\columnwidth}|>{\centering}p{0.35\columnwidth}|>{\centering}p{0.35\columnwidth}|}
\hline 
